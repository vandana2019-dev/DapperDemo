...
namespace DapperDemo.Repository
{
    public class CompanyRepository : ICompanyRepository
    {
        ...
        public Company Add(Company company)
        {
            ...
            //{
            //    company.Name, // the Property name matches the paramter name (we can remove @Name) /// Similarly for others too
            //    company.Address,
            //    company.City,
            //    company.State,
            //    company.PostalCode
            ...
            // Instead of giving single parameters, we can just give class name, which maps the parameters
